...
class ReplaceViewPublicacoesBuscaSprint024 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement("
            CREATE OR REPLACE VIEW publicacoes_busca AS 
                ...
                LEFT JOIN publicacoes_conteudos pc ON pc.publicacao_id = p.id AND pc.rascunho = FALSE AND pc.publicacao_conteudo_tipo_id IN (SELECT id FROM publicacoes_conteudos_tipos WHERE nome = 'TEXTO') 
                GROUP BY p.id 
        ");
    }
