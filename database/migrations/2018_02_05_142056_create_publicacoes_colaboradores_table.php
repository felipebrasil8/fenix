...
class CreatePublicacoesColaboradoresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('publicacoes_colaboradores', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('publicacoes_colaboradores');
    }
}
