<template>
    <modal name="publicacao-nova-modal" transition="pop-out" :width="modalWidth" height="auto" @before-close="beforeClose"  @before-open="beforeOpen" :clickToClose="false">
        <div class="modal-content" >
            <div class="modal-header">    
              <button type="button" class="close" @click="$modal.hide('publicacao-nova-modal')" ><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                <form method="post"  data-toggle="validator" role="form" class="formcadastrar">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-danger" @click="$modal.hide('publicacao-nova-modal')" type="button">Cancelar</button> 
...
<script>
    ...
    export default {
        ...
        computed:{
            isDisabled(){
                if( (this.item.titulo != '' && this.item.resumo != '' && (this.item.lista_relacionados != '' && 
                        this.item.lista_relacionados >= 0 && this.item.lista_relacionados < 100) ) && !this.validaBotao) {
                    return false;
                }
                return true; 
            }
