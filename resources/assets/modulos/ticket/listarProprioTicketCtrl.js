(function(){
    ...
    angular.module('app')
    .controller('listarProprioTicketCtrl', ['$scope', '$http', 'TicketFactory', '$cookies', '$filter', '$location', function($scope, $http, TicketFactory, $cookies, $filter, $location) {
        var $ctrl = this;
        ...
        var init = function ()
        {
            ...
            {
                $scope.filtro = ( 
                    $cookies.get('ticket_proprio_codigo') == "" && 
                    $cookies.get('ticket_proprio_assunto') == "" && 
                        (isNaN(parseInt($cookies.get('ticket_proprio_usuario_responsavel'))) || $cookies.get('ticket_proprio_usuario_responsavel') == "0") && 
                             ($cookies.get('ticket_proprio_aberto') == "true") &&
                              (isNaN(parseInt($cookies.get('ticket_proprio_ticket_de'))) || $cookies.get('ticket_proprio_ticket_de') == "") && 
                                  (isNaN(parseInt($cookies.get('ticket_proprio_ticket_ate'))) || $cookies.get('ticket_proprio_ticket_ate') == "") && 
                                    (isNaN(parseInt($cookies.get('ticket_proprio_usuario_solicitante'))) || $cookies.get('ticket_proprio_usuario_solicitante') == "0") &&
                                         (isNaN(parseInt($cookies.get('ticket_proprio_departamento'))) || $cookies.get('ticket_proprio_departamento') == "0"))? false : true;
        ...
        var verificaCookies = function(){            
            ...
            if(typeof $cookies.get('ticket_proprio_codigo') == "undefined" && 
                typeof $cookies.get('ticket_proprio_assunto') == "undefined" && 
                    typeof $cookies.get('ticket_proprio_ticket_de') == "undefined" && 
                        typeof $cookies.get('ticket_proprio_ticket_ate') == "undefined" && 
                            typeof $cookies.get('ticket_proprio_aberto') == "undefined" && 
                                typeof $cookies.get('ticket_proprio_usuario_responsavel') == "undefined" &&
                                            typeof $cookies.get('ticket_proprio_categoria') == "undefined" &&
                                                typeof $cookies.get('ticket_proprio_statuse') == "undefined" &&
                                                    typeof $cookies.get('ticket_proprio_prioridade') == "undefined"           
                    ) 
            {
                return false;
            }
        ...
        $scope.pesquisaTicket = function(pesquisa) {
            ...
            TicketFactory.pesquisarTicketProprio($scope.filter)
