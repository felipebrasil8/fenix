...
<section class="content" id="app_base_de_conhecimento">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-12 margin-top" id="categoria_menu">
            <vc-categoria 
                ...
                permissao_botao="{{$can ? 'true' : 'false'}}" 
                can_categoria="{{ $can_categoria ? $can_categoria : '' }}">
            </vc-categoria>
        </div>
    
        <div class="col-lg-9 col-md-9 col-sm-12 margin-top" style="float: right; padding-left: 0px;">
            <vc-publicacao-historico publicacao_id="{{ $publicacao_id ?? 0 }}"></vc-publicacao-historico>
        </div>
    ...
    @can('BASE_PUBLICACOES_CONTEUDO_EDITAR')
        <tags-modal  publicacao_id="{{ $publicacao_id ?? 0 }}"></tags-modal>
        <colaboradores-modal  publicacao_id="{{ $publicacao_id ?? 0 }}" funcionarios="{{ $funcionarios }}" colaboradores="{{ $colaboradores }}"></colaboradores-modal>
    @endcan
