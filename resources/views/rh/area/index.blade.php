...
<migalha titulo="Áreas" descricao="Pesquisar área"></migalha>
    
<section class="content" ng-controller="listarAreaCtrl"> 

    <div class="row">
        <div class="col-md-12">
            <div class="box box-default @{{ filtro == true ? '' : 'collapsed-box'}}">
                
                <form role="form" ng-submit="pesquisaArea(filter)">                
                    ...
                    <div class="box-body row">
                        ...
                        <div class="form-group col-md-3">
                            <label>Gestor:</label>
                            <select class="form-control input-sm" ng-model="filter.gestor" ng-options="x.nome for x in gestores" ng-init="setSelect();">
                            </select>                            
                        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tr ng-repeat="area in lista">
                            ...
                            <td class="text-center">
                                @can( 'RH_AREA_STATUS' )
                                <a href="#" title="@{{ area.ativo == true ? 'Ativo, clique para desativar.' : 'Inativo, clique para ativar.'}}"  ng-click="modalConfirm(area, lista, 'rh/area')" data-toggle="modal">
                                <!-- data-toggle="modal" data-target="#modal-default" -->
                                @endcan                                
                                    <i ng-class="{true:'fa fa-check-square-o', false:'fa fa-square-o'}[area.ativo]"></i>
                                @can( 'RH_AREA_STATUS' )
                                </a>
                                @endcan
                            </td>
                            <td class="text-center">
                                @can( 'RH_AREA_EDITAR' )
                                <a href="/rh/area/@{{ area.id }}/edit" title="Editar"><i class="fa fa-pencil-square-o"></i></a>
                                @endcan
                                &nbsp;
                                @can( 'RH_AREA_VISUALIZAR' )
                                <a href="/rh/area/@{{ area.id }}" title="Visualizar"><i class="fa fa-file-text-o"></i></a>
                                @endcan
                            </td>
                        </tr>                    
                        <tr>
                            <td colspan="4" ng-show="lista.length == 0">Nenhuma informação encontrada!!!</td>
                        </tr>
                    </table>
                </div>
                <!-- Copiar -->
            ...
            <div class="">
                <a href="/rh/area/create" title="Cadastrar">
